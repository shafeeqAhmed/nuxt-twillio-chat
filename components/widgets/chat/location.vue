<template>
  <div id="content">
    ...
    <div class="row">
      ...
      <div class="col-2">
        <b-input-group>
          <button class="btn btn-primary" @click="loadMap()">update</button>
        </b-input-group>
      </div>
    </div>
    ...
    <div class="row mt-3">
      <button @click="applyFilter()" class="btn btn-primary ml-2">Apply</button>
      <button @click="$emit('closeModel')" class="btn btn-secondary ml-2">
        Cancel
      </button>
    </div>
  </div>
