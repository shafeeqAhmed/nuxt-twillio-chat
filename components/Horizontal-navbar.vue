<script>
import { influencerMenuItems, menuItems } from "./horizontal-menu";
      ...
      <div class="container-fluid">
        <nav class="navbar navbar-light navbar-expand-lg topnav-menu">
          <div class="collapse navbar-collapse" id="topnav-menu-content">
            <!-- for admin scope -->
            <ul class="navbar-nav" v-if="$auth.hasScope('admin')">
              <li
            ...
            <!-- for influencer scope -->
            <ul class="navbar-nav" v-if="$auth.hasScope('influencer')">
              <li
                class="nav-item dropdown"
                v-for="(item, index) of influencerMenuItems"
                :key="index"
              >
                <nuxt-link
                  tag="a"
